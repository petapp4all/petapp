      ...
      >
        ...
        >
          ...
          <SidebarItem
            ...
            onPress={() => handleNavigation("/(screen)/user-details")}
          />
          <SidebarItem
            icon={<Feather name="headphones" size={20} color="black" />}
            text="Contact Support"
            onPress={() => handleNavigation("/(screen)/contact")}
          />
          <SidebarItem
